...
<div class="last-update1">Last updated: October 15, 2022</div>
...
<div class="last-update">Interpretation and Definitions</div>
...
<p><strong>For the purposes of this Privacy Policy:</strong></p>
    ...
    <ul>
        ...
        <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to VNV Enterprises, B 53 Sarvodaya Enclave New Delhi 110017 .</li>
        ...
        <li><strong>Website</strong> refers to Studio Ekko , accessible from studioekko.com</li>
        <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
        </ul>


<div class="last-update">Collecting and Using Your Personal Data</div>
...
<ul>
    ...
    <li><strong>Web Beacons.</strong> Certain sections of our Service and our emails may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of a certain section and verifying system and server integrity).<br/>
        Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your personal computer or mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the Free Privacy Policy website article.</li>
</ul>
...
<p>If you have any questions about this Privacy Policy, You can contact us:<br/>
    By email: <a href="mailto:info@studioekko.com">info@studioekko.com</a></p>
