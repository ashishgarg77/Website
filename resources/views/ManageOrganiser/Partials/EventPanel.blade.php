<div class="panel panel-success event">
    ...
    <div class="panel-footer">
        <ul class="nav nav-section nav-justified">
           ...
           <!-- @if($event->tickets->sum('quantity_sold')==0)    @endif-->
            <li>
                <a href="{{route('deleteOrganiserEvents', ['organiser_id' => $event->organiser->id,'event_id' => $event->id])}}">
                    <i class="ico-edit"></i> Delete
                </a>
            </li>
