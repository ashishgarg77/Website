                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row starttime" style="display:none;">
                            <div class="">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        {!! Form::label('other_start_date', 'Other Start Date', array('class'=>' control-label')) !!}
                                        {!!  Form::text('other_start_date[]', old('other_start_date'),
                                                            [
                                                        'class'=>'form-control start hasDatepicker ',
                                                        'data-field'=>'datetime',
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        {!!  Form::label('other_end_date','Other End Date',
                                                    [
                                                'class'=>'required control-label '
                                            ])  !!}

                                        {!!  Form::text('other_end_date[]', old('other_end_date'),
                                                    [
                                                'class'=>'form-control end hasDatepicker ',
                                                'data-field'=>'datetime',
                                                'data-startend'=>'endlm',
                        ...
                        <div class="address-manual">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    {!! Form::label('website_link', trans("Organiser.website_link"), array('class'=>'required control-label ')) !!}
                                    {!!  Form::text('website_link', old('website_link'),
                                                array(
                                                'class'=>'form-control',
                                                'placeholder'=>trans("Website Link")
                                                ))  !!}
                                </div>
                                <div class="form-group">
                                    {!! Form::label('facebook_link', trans("Organiser.facebook_link"), array('class'=>'required control-label ')) !!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('twitter_link', trans("Organiser.facebook_link"), array('class'=>'required control-label ')) !!}
                                    {!!  Form::text('twitter_link', old('facebook_link'),
                                                array(
                                                'class'=>'form-control',
                                ...
                                <div class="form-group">
                                    {!! Form::label('youtube_link', trans("Organiser.youtube_link"), array('class'=>'required control-label ')) !!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('language', trans("Organiser.language"), array('class'=>'required control-label ')) !!}
                                ...
                                <div class="form-group">
                                    {!! Form::label('Capacity', trans("Organiser.Capacity"), array('class'=>'required control-label ')) !!}
                                    {!!  Form::text('capacity', old('Capacity'),
                                                array(
                                                'class'=>'form-control',
                                                'placeholder'=>trans("Capacity")
                                                ))  !!}
                                </div>
