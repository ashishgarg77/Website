...
<section id="tickets" class="container">
    ...
    @else
        ...
        @if($tickets->count() > 0)
		 ...
		 <a href="javascript:;"><img src="{{ url('/') }}/images/footer-sc1.svg" class="v_ev_del v_ev_del1" style="display:block !important;"> BUY TICKET</a>
...
<?php //dd($event); ?>
 <div class="addto-cart-event-details">
          ...
          <div class="ada">
            <h5>Time</h5>
            <p> {{  date('h:i A', strtotime($event->start_date))}}</p>
        </div>
        <div class="ada">
            <h5>Capacity</h5>
            <p>{{ $event->capacity }}</p>
        ...
        <div class="ada">
            ...
            <p> {{ $event->age_group }}</p>
		     ...
		     <div class="ada">
            <h5>Requirements</h5>
            <p>Please check event details</p>
        </div>
