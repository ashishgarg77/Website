...
Route::group(
    ...
    Route::group(['middleware' => ['auth', 'first.run']], function () {
        ...
        Route::group(['prefix' => 'organiser'], function () {
            ...
            Route::get('{organiser_id}/delete-category-event/{category_id}',
                [OrganiserController::class, 'deleteCategory']
            )->name('deletecategory');

            Route::get('{organiser_id}/delete-news/{news_id}',
            [OrganiserController::class, 'deleteNews']
            )->name('deleteNews');
            ...
            Route::get('{organiser_id}/deleteevents/{event_id}',
                [OrganiserEventsController::class, 'deleteEvent']
            )->name('deleteOrganiserEvents');
    ...
    [IndexController::class, 'privacypolicy']
    )->name('privacypolicy');

        Route::get('/terms-and-conditions',
        [IndexController::class, 'termsandconditions']
    )->name('termsandconditions');


    Route::get('/refund-cancellation',
        [IndexController::class, 'refundcancellationpolicy']
