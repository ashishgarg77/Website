...
class Event extends MyBaseModel
{
    ...
    protected $messages = [
        ...
        'event_image.mimes'                    => 'Please ensure you are uploading an image (heic,JPG, PNG, JPEG)',
    ...
    public function rules()
    {
        ...
        return [
            ...
            'event_image'         => 'nullable|mimes:jpeg,jpg,png,heic|max:3000',
        ];
    }
    ...
    public function mystaartformat()
    {
        return $this->start_date->format('M,d Y h:i');
    }

    public function myendtimeformat()
    {
